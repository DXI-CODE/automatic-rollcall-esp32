    ...
    <div>
        ...
        <div class="content">
           ...
           <a href="/views/welcome.blade.php" class="regresa-inicio">
                <img src="<?php echo e(asset('datos/icon-home.webp')); ?>" alt="Inicio">
                Inicio
            </a>
            ...
            <div class="search">
                ...
                <button id="btn"><span>  <img src="<?php echo e(asset('datos/search-icon.webp')); ?>" class="iconCal"> </img> </span></i></button>
            </div>
            <div class="print">
...
<script src="<?php echo e(asset('/js/horario.js')); ?>"></script>
</html>
<?php /**PATH C:\xampp\htdocs\Proyecto_Ing5\ProyectoSistemasEmbebidos\sistemasEmbebidos\resources\views/horario.blade.php ENDPATH**/ ?>